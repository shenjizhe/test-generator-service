 ...
 *
 * @File: TestQuestionRecordController.java
 * @Author: JasonShen
...
@Slf4j
@RestController
@RequestMapping("/test-question-records")
@Api(tags = "题目问题记录")
public class TestQuestionRecordController extends BaseController<TestQuestionRecord> {
    @Autowired
    private TestQuestionRecordService service;
     ...
     * 题目问题记录-批量查询
     */
    @ApiOperation(value = "题目问题记录-批量查询", notes = "")
    @GetMapping("/batch/")
    public Result<List<TestQuestionRecord>> batchSelect(
     ...
     * 题目问题记录-批量添加
     */
    @ApiOperation(value = "题目问题记录-批量添加", notes = "")
    @PostMapping("/batch/")
    public Result<Integer> batchInsert(
            @RequestBody List<TestQuestionRecord> records
    ) {
     ...
     * 题目问题记录-批量删除
     */
    @ApiOperation(value = "题目问题记录-批量删除", notes = "")
    @DeleteMapping("/batch/")
     ...
     * 题目问题记录-添加
     */
    @ApiOperation(value = "题目问题记录-添加", notes = "")
    @PostMapping("/")
    public Result<Integer> singleInsert(
            @RequestBody TestQuestionRecord record
    ) {
     ...
     * 题目问题记录-修改
     */
    @ApiOperation(value = "题目问题记录-修改", notes = "")
    @PutMapping("/")
     ...
     * 题目问题记录-删除
     */
    @ApiOperation(value = "题目问题记录-删除", notes = "")
    @DeleteMapping("/{id}/")
