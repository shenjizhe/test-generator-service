 ...
 *
 * @File: TestOptionRecordServiceImpl.java
 * @Author: JasonShen
...
import com.bfec.testgenerator.testgenerator.mapper.TestOptionRecordMapper;
 ...
 */
@Service
public class TestOptionRecordServiceImpl
    extends BaseServiceImpl<TestOptionRecord>
    implements TestOptionRecordService {

    @Resource
    private TestOptionRecordMapper mapper;
