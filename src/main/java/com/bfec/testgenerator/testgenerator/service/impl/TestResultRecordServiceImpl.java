 ...
 *
 * @File: TestResultRecordServiceImpl.java
 * @Author: JasonShen
...
import com.bfec.testgenerator.testgenerator.mapper.TestResultRecordMapper;
 ...
 */
@Service
public class TestResultRecordServiceImpl
    extends BaseServiceImpl<TestResultRecord>
    implements TestResultRecordService {

    @Resource
    private TestResultRecordMapper mapper;
