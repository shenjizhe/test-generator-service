 ...
 *
 * @File: TestExpressionServiceImpl.java
 * @Author: JasonShen
...
import com.bfec.testgenerator.testgenerator.mapper.TestExpressionMapper;
 ...
 */
@Service
public class TestExpressionServiceImpl
    extends BaseServiceImpl<TestExpression>
    implements TestExpressionService {

    @Resource
    private TestExpressionMapper mapper;
